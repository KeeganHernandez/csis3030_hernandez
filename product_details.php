    ...
    <div id="container">
        ...
        <header>
            ...
            <div id="slides-container" class="slides-container width">
                ...
                <div class="controls"><span class="jFlowNext"><span>Next</span></span><span class="jFlowPrev"><span>Prev</span></span>
                </div>
        ...
        <div id="body" class="width">
            ...
            <section id="content" class="two-column with-right-sidebar">
                ...
                <article>
                    ...
                    echo "<img src='images/" . $row['image'] . "' width='250px'/>" . "<br/>";
                    echo $row['price'] . "<br />";
                    ...
                    Quantity: <input type="text" name="product_<?php echo $product_id ?>" value="<?php echo $quantity ?>" size="3">
                    <input type="submit">
                    </form>
                ...
                <article class="expanded">
                    ...
                    <div class="article-info">Posted on
                        <time datetime="2013-05-14">14 May</time> by <a href="#" rel="author">Joe Bloggs</a></div>
            ...
            <aside class="sidebar big-sidebar right-sidebar">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="newslist">
                            <li>
                                <p><span class="newslist-date">Jul 21</span> Quisque hendrerit lorem sit amet dui viverra dictum. Phasellus imperdiet magna sit amet arcu tristique ultricies ut in dui.</p>
                            </li>

                            <li>
                                <p><span class="newslist-date">May 09</span> Mauris et felis semper, congue dui ac, iaculis ipsum. Fusce non rhoncus risus, quis luctus nisl. Donec vitae velit tincidunt, tincidunt felis eu, suscipit nibh. </p>
